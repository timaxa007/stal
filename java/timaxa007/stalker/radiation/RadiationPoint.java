...
public class RadiationPoint {
	...
	public RadiationPoint(final double posX, final double posY, final double posZ, final float radius, final int radiationMax) {
		this.posX = posX;
		this.posY = posY;
		this.posZ = posZ;
		this.radius = radius;
	...
	@Deprecated
	public RadiationPoint(final net.minecraft.util.Vec3 vec, final float radius, final int radiationMax) {
